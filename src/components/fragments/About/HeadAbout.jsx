  ...
  return (
    <>
      <section className="relative gap-2 flex flex-col ">
        <div className="overflow-hidden leading-loose bg-zinc-800 w-full lg:h-dvh   h-fit rounded-[1.5rem] flex flex-col justify-center items-center">
          <div className="p-[1.5rem] font-normal h-fit text-justify  text-[0.75rem] sm:text-[1rem]  text-zinc-100 space-y-4 ">
            ...
            <p>
              Chengdu Shuiyueyu Technology Co., Ltd. Founded in 2015, this
              Chinese company integrates creativity, design, R&D, mass
              production, and marketing, earning trust for its MOONDROP brand's
        ...
        <div className="overflow-hidden relative leading-loose bg-zinc-800 w-full h-full rounded-[1.5rem]">
          ...
          <div className="p-[1.5rem] absolute  font-normal text-[0.75rem] h-full w-full sm:text-[1rem] flex justify-center flex-col items-center text-zinc-100 space-y-4">
            ...
            <p className="text-justify ">
              MOONDROP focuses on integrating diverse technologies in product
              R&D, exploring new materials and processes. With several patents
              in telecommunications and design, the company aims to boost
              innovation, explore technological frontiers, and support the
