...
function BodyHome() {
  return (
    <div className=" relative overflow-hidden leading-loose ">
      <div className="p-[1.1rem] font-semibold h-full text-[1rem] text-justify lg:text-[1.2rem]  text-black space-y-4">
        ...
        <div className="w-full flex lg:justify-start justify-end pb-2">
          <ButtonCta linkPage="/about" classname="lg:px-12 lg:py-6 px-10 py-4">
            More
          </ButtonCta>
        </div>
      </div>
